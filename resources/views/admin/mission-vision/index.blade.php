        ...
        <div class="flex items-center justify-between mb-12">
            <div>
                <h1 class="text-2xl font-display font-black uppercase italic text-industrial-dark dark:text-white">
                    Mission & <span class="text-industrial-blue">Vision</span>
                </h1>
                <p class="text-sm text-slate-500 uppercase tracking-widest font-bold mt-1">Live Content Editor</p>
            </div>
            
            @if(session('success'))
                <div class="flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700 rounded-lg border border-green-100 animate-fade-in-down">
                        ...
                        <div class="flex items-center gap-4 mb-8 group">
                            ...
                            <div class="flex-1">
                                <input type="text" name="mission[title]" value="{{ $mvItems['mission']['title'] }}" 
                                    class="w-full text-3xl md:text-4xl font-display font-black uppercase italic text-industrial-dark dark:text-white bg-transparent border-none focus:ring-0 p-0 placeholder:text-slate-300" 
