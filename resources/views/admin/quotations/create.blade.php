<x-layouts.app title="Create Quotation">
    ...
    <div class="space-y-8 pb-10">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white font-outfit">Create Quotation
                </h1>
                <p class="text-gray-500 dark:text-gray-400 mt-2">Create a new client quotation</p>
            </div>
        ...
        <form action="{{ route('admin.quotations.store') }}" method="POST" id="quotationForm">
            ...
            <div class="glass-card p-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Enter client details</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="client_name" required class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all" placeholder="John Doe">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Company Name</label>
                        <input type="text" name="client_company" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all" placeholder="ABC Corporation">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Email</label>
                        <input type="email" name="client_email" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all" placeholder="john@example.com">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Phone</label>
                        <input type="text" name="client_phone" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all" placeholder="+880 1234-567890">
                    </div>

                    <div class="lg:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Address</label>
                        <textarea name="client_address" rows="3" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all resize-none" placeholder="Enter client address"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" value="{{ $quotationNumber }}" readonly class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-surface-700 text-gray-900 dark:text-white">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="valid_until" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all">
                    </div>
            ...
            <div class="glass-card p-8">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Add products, services, or custom items</p>
                        </div>
                    </div>
                ...
                <div id="noItems" class="text-center py-12 bg-gray-50 dark:bg-surface-800 rounded-xl">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Click "Add Item" to start adding products or services</p>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('admin.quotations.index') }}" class="px-6 py-3 rounded-xl border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-surface-700 transition-all">
                    Cancel
                </a>
