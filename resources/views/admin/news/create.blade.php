<x-layouts.app title="Create News Article">
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white font-outfit tracking-tight">Write News Article</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Create a new post for your audience.</p>
            </div>
        </div>
                    ...
                    <div class="glass-card p-6 sm:p-8 space-y-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="e.g. Influx Group Expands Renewable Energy Portfolio"
                            ...
                            <div>
                                ...
                                <textarea name="excerpt" id="excerpt" rows="2" required placeholder="A brief overview of the article for the list view..."
                                    class="w-full px-4 py-2.5 bg-gray-50/50 dark:bg-surface-900/50 border border-gray-200 dark:border-white/10 rounded-xl text-sm focus:ring-2 focus:ring-brand-500 outline-none transition-all dark:text-white">{{ old('excerpt') }}</textarea>
                                <x-input-error :messages="$errors->get('excerpt')" class="mt-2" />
                            </div>

                            <div>
                                <label for="content" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Full Content</label>
                                <textarea name="content" id="content" rows="12" required placeholder="Tell your story here..."
                                    class="w-full px-4 py-2.5 bg-gray-50/50 dark:bg-surface-900/50 border border-gray-200 dark:border-white/10 rounded-xl text-sm focus:ring-2 focus:ring-brand-500 outline-none transition-all dark:text-white">{{ old('content') }}</textarea>
                    ...
                    <div class="glass-card p-6 sm:p-8 space-y-6">
                        ...
                        <div class="relative group aspect-video">
                            <div class="w-full h-full rounded-2xl border-2 border-dashed border-gray-200 dark:border-white/10 flex flex-col items-center justify-center gap-2 text-gray-400 group-hover:border-brand-500 transition-all overflow-hidden relative">
                                ...
                                <span class="text-xs font-semibold text-center px-4">Upload Article Image</span>
                    ...
                    <div class="glass-card p-6 sm:p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="category" id="category" required
                                ...
                                <option value="company-updates" {{ old('category') == 'company-updates' ? 'selected' : '' }}>Company Updates</option>
                                ...
                                <option value="milestones" {{ old('category') == 'milestones' ? 'selected' : '' }}>Milestones</option>
                            </select>
                        </div>
                    </div>
