<x-layouts.app title="Create Service/Solution">
    <x-slot:styles>
    ...
    <div class="space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white font-outfit tracking-tight">Create New Item</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Add a new service or solution.</p>
            </div>
        </div>

        <form action="{{ route('admin.services-and-solutions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" required onchange="toggleTypeFields()"
                                    ...
                                    <option value="solution" {{ old('type') == 'solution' ? 'selected' : '' }}>Solution</option>
                                </select>
