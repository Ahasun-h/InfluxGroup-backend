    ...
    <div class="space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center justify-center px-4 py-3 rounded-2xl bg-gray-100 dark:bg-surface-700 text-gray-700 dark:text-gray-300 font-bold transition-all hover:-translate-y-1 active:translate-y-0 gap-2">
