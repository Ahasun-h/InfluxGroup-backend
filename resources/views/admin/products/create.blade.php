                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="category" id="category" required
                                    ...
                                    <option value="transformers" {{ old('category') == 'transformers' ? 'selected' : '' }}>Transformers</option>
                                    <option value="switchgear" {{ old('category') == 'switchgear' ? 'selected' : '' }}>Switchgear</option>
                                    <option value="renewables" {{ old('category') == 'renewables' ? 'selected' : '' }}>Renewables</option>
